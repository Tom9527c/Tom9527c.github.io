...
if (localStorage.getItem("blogbg") != undefined) {
    ...
    --darkmode-bg:url(https://sourcebucket.s3.bitiful.net/img/dm2.webp);
    --mobileday-bg: url(https://sourcebucket.s3.bitiful.net/img/dm2.webp);
    --mobilenight-bg: url(https://sourcebucket.s3.bitiful.net/img/dm2.webp);
  }`;
}
function changeBg(s) {
