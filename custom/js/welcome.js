...
let ipLocation;
sendJsonpRequest(ipUrl, {
    key: 'ZR3BZ-AB633-VYY36-OL2J7-BPOP3-SIBPV',
    output: 'jsonp',
}, function (res) {
    ipLocation = res
});
...
function showWelcome() {
    let dist = getDistance(113.27143134,23.13533631, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
